...
// ----------------------------------------------------
// Code for Ben Eater's 6502 computer
// 06/Jun/2022 improved spacing, tabs, readability 
// ----------------------------------------------------
		*=$8000 "Main Program"
.encoding	"ascii"
...
// ----- @Step 1 Configure 6522@ -----
	...
	jmp end_reset
// ----- @LCD Reset@ -----
// Initialization steps as per LCD Data Sheet: Wait 15ms; 4.1 ms; .1 ms; Function Set; Display Off; Display Clear; Entry Mode Set 
...
//		jsr lcd_instruction
	...
	+++++++++++++++++++++++++++++++++++++++*/
// Here I use standard "print" method; one char is printed after the other
...
//!here:		jmp !here-
	...
	+++++++++ DIRECT WRITE TO LCD +++++++++++  
	+++++++++++++++++++++++++++++++++++++++*/
// Here I set the location for each char to be printed just before actually printing it 
// jmp !exit++
direct_write:
// ----- @First line@ -----
line1_write:
